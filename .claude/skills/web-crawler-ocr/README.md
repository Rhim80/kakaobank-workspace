...
# Static sites
python .claude/skills/web-crawler-ocr/scripts/web-crawler.py "https://example.com" /tmp/test.md --no-ocr

# Dynamic/SPA sites (Olive Young, Coupang, Musinsa etc.)
python .claude/skills/web-crawler-ocr/scripts/web-crawler.py "https://oliveyoung.co.kr/..." /tmp/oy.md --wait 5000 --scroll --max-images 10
```
